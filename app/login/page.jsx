...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <Link href="/" className="absolute top-8 left-8 flex items-center gap-2 text-white font-black tracking-tighter uppercase italic">
      ...
      <div className="w-full max-w-md bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 rounded-2xl p-8 shadow-2xl flex flex-col items-center text-center z-10">
        ...
        <h1 className="text-2xl font-black italic uppercase tracking-tighter text-white mb-2">Welcome Back</h1>
        <p className="text-neutral-400 text-sm mb-8 font-medium">Sign in with Discord to continue your guessing streak and climb the leaderboard.</p>
