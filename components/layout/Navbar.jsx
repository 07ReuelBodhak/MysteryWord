...
export function Navbar() {
  ...
  console.log("Session in Navbar:", session); // Debugging line to check session data
    ...
    <nav className="sticky top-0 z-40 w-full h-16 border-b border-neutral-800 px-6 flex items-center justify-between bg-black/50 backdrop-blur-md">
      <div className="max-w-7xl w-full mx-auto flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link
            href="/home"
            className="text-xl font-black tracking-tighter uppercase italic text-white flex items-center gap-2"
          >
